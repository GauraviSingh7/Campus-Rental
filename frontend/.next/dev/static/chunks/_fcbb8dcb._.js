...
function LoginPage() {
    ...
    if ($[0] !== "ae1a1c7f965ec2cff70094c0955f4da3b750084b336e6a90639883b0ea2840ef") {
        for(let $i = 0; $i < 44; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ae1a1c7f965ec2cff70094c0955f4da3b750084b336e6a90639883b0ea2840ef";
    }
    ...
    if ($[1] !== router) {
        t0 = ({
            "LoginPage[handleAction]": (e)=>{
                e.preventDefault();
                router.push("/explore");
            }
        })["LoginPage[handleAction]"];
        $[1] = router;
        $[2] = t0;
    } else {
        t0 = $[2];
    }
    const handleAction = t0;
    let t1;
    ...
    const t3 = isLogin ? "Welcome Back" : "Join Agora";
    let t4;
    if ($[5] !== t3) {
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "LoginPage[<button>.onClick]": ()=>setRole("student")
        })["LoginPage[<button>.onClick]"];
        $[7] = t5;
    } else {
        t5 = $[7];
    }
    const t6 = `flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all ${role === "student" ? "bg-white text-[#2da2c8] shadow-md" : "text-gray-600"}`;
    let t7;
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = ({
            "LoginPage[<button>.onClick]": ()=>setRole("admin")
        })["LoginPage[<button>.onClick]"];
        $[11] = t9;
    } else {
        t9 = $[11];
    }
    const t10 = `flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all ${role === "admin" ? "bg-white text-[#ef4444] shadow-md" : "text-gray-600"}`;
    let t11;
    ...
    let t14;
    if ($[18] !== isLogin) {
        t14 = !isLogin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            type: "text",
    ...
    let t17;
    if ($[22] !== isLogin) {
        t17 = isLogin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t19 = `w-full py-4 mt-4 rounded-full font-bold text-white text-2xl shadow-xl transition-all active:scale-95 ${role === "admin" ? "bg-[#ef4444]" : "bg-[#2da2c8]"}`;
    const t20 = isLogin ? "Login" : "Sign Up";
    let t21;
    if ($[26] !== t19 || $[27] !== t20) {
    ...
    let t22;
    if ($[29] !== handleAction || $[30] !== t14 || $[31] !== t18 || $[32] !== t21) {
    ...
    const t24 = isLogin ? "New to Agora? Create Account" : "Already have an account? Log In";
    let t25;
    if ($[36] !== t23 || $[37] !== t24) {
...
_s(LoginPage, "Ef5LUxd7x/8aPTcUrXzrqNjqS+0=", false, function() {
    return [
...
//# sourceMappingURL=_fcbb8dcb._.js.map