...
function ExplorePage() {
    ...
    if ($[0] !== "e4fc1433a6194f6cb4de3005a06177afd3f4532c3787cdbd702619dd7315360c") {
        for(let $i = 0; $i < 65; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e4fc1433a6194f6cb4de3005a06177afd3f4532c3787cdbd702619dd7315360c";
    }
    ...
    let t6;
    let t7;
    if ($[1] !== isProfileOpen || $[2] !== router || $[3] !== searchTerm) {
        let t8;
        if ($[12] !== searchTerm) {
            t8 = ({
                "ExplorePage[INITIAL_ITEMS.filter()]": (item)=>item.title.toLowerCase().includes(searchTerm.toLowerCase())
            })["ExplorePage[INITIAL_ITEMS.filter()]"];
            $[12] = searchTerm;
            $[13] = t8;
        } else {
            t8 = $[13];
        }
        const filteredItems = INITIAL_ITEMS.filter(t8);
        t4 = "min-h-screen";
        if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = ({
                "ExplorePage[<div>.onClick]": ()=>setIsProfileOpen(false)
            })["ExplorePage[<div>.onClick]"];
            $[14] = t5;
        } else {
            t5 = $[14];
        }
        ...
        if ($[16] !== router) {
            t9 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onClick: {
                    "ExplorePage[<div>.onClick]": ()=>router.push("/explore")
                }["ExplorePage[<div>.onClick]"],
                children: "AGORA"
            }, void 0, false, {
                fileName: "[project]/app/explore/page.tsx",
        ...
        if ($[19] === Symbol.for("react.memo_cache_sentinel")) {
            t11 = ({
                "ExplorePage[<input>.onChange]": (e)=>setSearchTerm(e.target.value)
        ...
        if ($[23] !== router) {
            t14 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: {
                    "ExplorePage[<button>.onClick]": ()=>router.push("/sell")
                }["ExplorePage[<button>.onClick]"],
        ...
        if ($[25] !== isProfileOpen) {
            t15 = ({
                "ExplorePage[<button>.onClick]": (e_0)=>{
                    e_0.stopPropagation();
        ...
        const t17 = `transition-transform duration-200 ${isProfileOpen ? "rotate-180" : ""}`;
        let t18;
        if ($[28] !== t17) {
        ...
        let t20;
        if ($[33] !== isProfileOpen || $[34] !== router) {
            t20 = isProfileOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute right-0 mt-3 w-56 bg-[#FFF8EE] rounded-2xl shadow-2xl border border-white/50 overflow-hidden z-[60]",
                onClick: _ExplorePageDivOnClick,
                children: [
        ...
        t2 = "p-10 max-w-7xl mx-auto";
        const t23 = searchTerm ? `Results for "${searchTerm}"` : "Items for Sale/Rent";
        let t24;
        if ($[46] !== t23) {
        ...
        t0 = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10";
        let t25;
        if ($[48] === Symbol.for("react.memo_cache_sentinel")) {
            t25 = ({
                "ExplorePage[filteredItems.map()]": (item_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        onClick: {
                            "ExplorePage[filteredItems.map() > <div>.onClick]": ()=>setSelectedItem(item_0)
                        }["ExplorePage[filteredItems.map() > <div>.onClick]"],
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `self-start px-4 py-1.5 rounded-lg text-[11px] font-black text-white mb-4 ${item_0.type.includes("SALE") ? "bg-[#E6A04D]" : "bg-[#4A7BB7]"}`,
            ...
            })["ExplorePage[filteredItems.map()]"];
            $[48] = t25;
        } else {
            t25 = $[48];
        }
        t1 = filteredItems.map(t25);
        $[1] = isProfileOpen;
        $[2] = router;
        $[3] = searchTerm;
        $[4] = t0;
    ...
    let t10;
    if ($[56] !== selectedItem) {
        t10 = selectedItem && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            onClick: {
                "ExplorePage[<div>.onClick]": ()=>setSelectedItem(null)
            }["ExplorePage[<div>.onClick]"],
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onClick: _ExplorePageDivOnClick2,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: {
                            "ExplorePage[<button>.onClick]": ()=>setSelectedItem(null)
                        }["ExplorePage[<button>.onClick]"],
    ...
    let t11;
    if ($[58] !== t10 || $[59] !== t4 || $[60] !== t5 || $[61] !== t6 || $[62] !== t7 || $[63] !== t9) {
...
_s(ExplorePage, "RMPQxADcLPaCAFeaOrcuIlQwgNc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = ExplorePage;
function _ExplorePageDivOnClick2(e_2) {
    return e_2.stopPropagation();
}
function _ExplorePageDivOnClick(e_1) {
...
//# sourceMappingURL=_337772db._.js.map